javascript: (function() {
    function copyToClipBoard() {
        var copyText = $j("iframe[name=gsft_main]").contents().find("#single-input-journal-entry .sn-stream-textarea-container #activity-stream-textarea")[0]; /* Select the text field */
            ...
            switch (openingTag) {
                ...
                case 'removebuttons':
                    button.click(function() {
                        $j("iframe[name=gsft_main]").contents().find('#single-input-journal-entry .form-field div#my-comments-preview').remove();
                        $j("iframe[name=gsft_main]").contents().find('#single-input-journal-entry .form-field button[id^="button-icon-"]').remove();
                        return false;
                    });
                    break;
                default:
